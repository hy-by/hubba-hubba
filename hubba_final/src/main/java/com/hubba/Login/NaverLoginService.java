...
public class NaverLoginService {
	private final static String CLIENT_ID = "ykm4bMrDtCbbnnxvyCWj";
	private final static String CLIENT_SECRET = "Y162Jpj4Fa";
	private final static String REDIRECT_URI = "http://localhost:8182/web/callback_naver";
