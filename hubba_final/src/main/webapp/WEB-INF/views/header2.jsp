...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAH8TyTGaGSOQ37eswOknD9FO_Z1MdhegQ"></script>
<meta charset="UTF-8">
...
<!-- 메인사진, 로그인, 검색 -->
<div class="container-fluid" id="first_container" style="height:500px;">
   <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner row"  style="height:500px;">
